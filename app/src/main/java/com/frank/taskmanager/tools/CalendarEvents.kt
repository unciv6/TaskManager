...
object CalendarEvents {
    ...
    private const val CALENDARS_ACCOUNT_TYPE = "com.frank.taskManager"
    ...
    private fun addCalendarAccount(context: Context): Long {
        ...
        value.put(
            CalendarContract.Calendars.ACCOUNT_NAME, CALENDARS_ACCOUNT_NAME
        )
        value.put(
            CalendarContract.Calendars.ACCOUNT_TYPE, CALENDARS_ACCOUNT_TYPE
        )
        value.put(
            CalendarContract.Calendars.CALENDAR_DISPLAY_NAME, CALENDARS_DISPLAY_NAME
        )
        ...
        value.put(
            CalendarContract.Calendars.OWNER_ACCOUNT, CALENDARS_ACCOUNT_NAME
        )
